...
public class ArrayDequeTest {
    ...
    private static class ArrayDequeSingletonAdapter implements Dequeue {
        public void addFirst(Object element) {
            ArrayDequeSingleton.addFirst(element);
        }

        public void addLast(Object element) {
            ArrayDequeSingleton.addLast(element);
        }

        public Object removeFirst() {
            return ArrayDequeSingleton.removeFirst();
        }

        public Object removeLast() {
            return ArrayDequeSingleton.removeLast();
        }

        public Object peekFirst() {
            return ArrayDequeSingleton.peekFirst();
        }

        public Object peekLast() {
            return ArrayDequeSingleton.peekLast();
        }

        public boolean isEmpty() {
            return ArrayDequeSingleton.isEmpty();
        }

        public int size() {
            return ArrayDequeSingleton.size();
        }
    }
    ...
    private static class ArrayDequeADTAdapter implements Dequeue {
        ...
        public void addFirst(Object element) {
            ArrayDequeADT.addFirst(deque, element);
        }

        public void addLast(Object element) {
            ArrayDequeADT.addLast(deque, element);
        }

        public Object removeFirst() {
            return ArrayDequeADT.removeFirst(deque);
        }

        public Object removeLast() {
            return ArrayDequeADT.removeLast(deque);
        }

        public Object peekFirst() {
            return ArrayDequeADT.peekFirst(deque);
        }

        public Object peekLast() {
            return ArrayDequeADT.peekLast(deque);
        }

        public boolean isEmpty() {
            return ArrayDequeADT.isEmpty(deque);
        }

        public int size() {
            return ArrayDequeADT.size(deque);
        }
    }
